...
Begin DesktopWindow WindowAbout
   ...
   Begin DesktopTextArea TextArea_Disclaimer
      ...
      Width           =   459
   End
   Begin DesktopLabel Label_Disclaimer
      AllowAutoDeactivate=   True
      Bold            =   True
      Enabled         =   True
      FontName        =   "System"
      ...
      Width           =   459
   End
   Begin DesktopButton PushButton_Close
      AllowAutoDeactivate=   True
      Bold            =   True
      Cancel          =   False
      Caption         =   "Close"
      ...
      Width           =   100
   End
   Begin DesktopLabel Label_License
      AllowAutoDeactivate=   True
      Bold            =   False
      Enabled         =   True
      FontName        =   "System"
...
#tag Events Label_X
	...
	#tag Event
		Sub MouseUp(x As Integer, y As Integer)
		  _
		  ShowURL("https://x.com/gvillena80")
		End Sub
	#tag EndEvent
	#tag Event
		Sub MouseExit()
